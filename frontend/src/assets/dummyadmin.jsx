...
export const styles = {
    ...
    tr: "border-b border-amber-500/20 hover:bg-[#3a2b2b]/30 transition-colors relative",
    imgCell: "p-4",
    img: "w-32 h-32 object-contain rounded-lg",
    nameCell: "p-4 align-middle",
    nameText: "text-amber-100 font-medium text-lg",
    descText: "text-sm text-amber-100/60",
    categoryCell: "p-4 text-amber-300 font-medium",
    priceCell: "p-4 text-amber-300 font-medium",
    ratingCell: "p-4",
    heartsCell: "p-4 text-amber-300 font-medium",
    ...
    // Thêm class mới cho input có icon
    inputFieldWithIcon: "w-full bg-[#3a2b2b]/50 border border-amber-500/20 rounded-xl pl-14 pr-4 py-3 sm:pl-16 sm:pr-5 sm:py-4 focus:outline-none focus:border-amber-400 text-amber-100",
    
    // Styles cho AddItems component
    label: "block text-amber-300 font-medium mb-2 text-sm sm:text-base",
    input: "w-full bg-[#3a2b2b]/50 border border-amber-500/20 rounded-xl px-4 py-3 sm:px-5 sm:py-4 focus:outline-none focus:border-amber-400 text-amber-100",
    inputWithIcon: "w-full bg-[#3a2b2b]/50 border border-amber-500/20 rounded-xl pl-12 pr-4 py-3 sm:pl-14 sm:pr-5 sm:py-4 focus:outline-none focus:border-amber-400 text-amber-100",
    textarea: "w-full bg-[#3a2b2b]/50 border border-amber-500/20 rounded-xl px-4 py-3 sm:px-5 sm:py-4 focus:outline-none focus:border-amber-400 text-amber-100 resize-none",
    heartIcon: "absolute left-4 top-1/2 -translate-y-1/2 text-amber-500 text-lg sm:text-xl",
